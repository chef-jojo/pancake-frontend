...
export const CardHeader: React.FC = () => {
  ...
  const gradientBorderColor = `linear-gradient(transparent ${gradientStopPoint}, ${theme.colors.cardBorder} ${gradientStopPoint}), ${theme.colors.gradientsCardHeader}`;
  return (
    <div style={{ padding: "32px", width: "500px" }}>
      <Row>
      ...
      <Row>
        <Card borderBackground={gradientBorderColor}>
          <Box background={theme.colors.gradientsCardHeader} p="16px" height={headerHeight}>
